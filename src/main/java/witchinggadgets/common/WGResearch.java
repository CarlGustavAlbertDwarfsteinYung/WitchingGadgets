...
public class WGResearch
{
	...
	public static void registerRecipes()
	{
		...
		//registerArcaneRecipe("CLOAK_STORAGE","", new ItemStack(WGContent.ItemCloak,1,2)/*ItemCloak.getCloakWithTag("STORAGE")*/, craftingAspects, "SCS"," B ", 'C', new ItemStack(WGContent.ItemCloak), 'S',new ItemStack(WGContent.ItemMaterial,1,3), 'B',new ItemStack(WGContent.ItemBag));

		craftingAspects = new AspectList().add(Aspect.FIRE,10).add(Aspect.ENTROPY,20).add(Aspect.EARTH, 15);
		registerArcaneRecipe("CLOAK_WOLF","", new ItemStack(WGContent.ItemCloak,1,2)/*ItemCloak.getCloakWithTag("WOLF")*/, craftingAspects, " W ","WCW", 'C', new ItemStack(WGContent.ItemCloak), 'W',new ItemStack(WGContent.ItemMaterial,1,6));

		if(WGModCompat.tfRavensFeather!=null)
		{
			craftingAspects = new AspectList().add(Aspect.AIR,15).add(Aspect.ORDER, 15);
			registerArcaneRecipe("CLOAK_RAVEN","", new ItemStack(WGContent.ItemCloak,1,3)/*ItemCloak.getCloakWithTag("RAVEN")*/, craftingAspects, " F ","FCF","FSF", 'C', new ItemStack(WGContent.ItemCloak), 'S',new ItemStack(ConfigItems.itemShard,1,0), 'F',new ItemStack(WGModCompat.tfRavensFeather));
		}
		...
		registerArcaneRecipe("WGBAUBLES","_WOLFVAMBRACES",new ItemStack(WGContent.ItemMagicalBaubles,1,2), craftingAspects, " P ","PVP", 'P', new ItemStack(WGContent.ItemMaterial,1,6), 'V', Items.leather);
		craftingAspects = new AspectList().add(Aspect.ORDER,10).add(Aspect.EARTH, 10);
		registerArcaneRecipe("WGBAUBLES","_KNOCKBACKSHOULDERS",new ItemStack(WGContent.ItemMagicalBaubles,1,1), craftingAspects, " S ","ETE", 'E', new ItemStack(ConfigItems.itemShard,1,3), 'S', Items.leather, 'T',"ingotThaumium");

		craftingAspects = new AspectList().add(Aspect.FIRE,10).add(Aspect.AIR, 10);
		registerArcaneRecipe("WGBAUBLES","_HASTEVAMBRACES", new ItemStack(WGContent.ItemMagicalBaubles,1,3), craftingAspects, " G ", "SLS", " P ", 'L', new ItemStack(Items.leather), 'G', new ItemStack(Items.gold_ingot), 'S', new ItemStack(Items.sugar), 'P', new ItemStack(Items.potionitem,1,8194));
		...
		craftingAspects = new AspectList().add(Aspect.EARTH,10).add(Aspect.AIR, 10);
		registerArcaneRecipe("WGBAUBLES","_DOUBLEJUMPSHOULDERS", new ItemStack(WGContent.ItemMagicalBaubles,1,0), craftingAspects, " S ", "FLF", " S ", 'L', new ItemStack(Items.leather), 'F', new ItemStack(Items.feather), 'S', new ItemStack(ConfigItems.itemShard,1,0), 'S', stack_ingot);


		craftingAspects = new AspectList().add(Aspect.AIR,16).add(Aspect.FIRE, 8).add(Aspect.ORDER,8);
		registerArcaneRecipe("WGBAUBLES","_SNIPERRING", new ItemStack(WGContent.ItemMagicalBaubles,1,6), craftingAspects, "A D", "BRE", "C F", 'R', new ItemStack(ConfigItems.itemBaubleBlanks,1,1), 'A', new ItemStack(ConfigItems.itemPrimalArrow,1,0), 'B', new ItemStack(ConfigItems.itemPrimalArrow,1,1), 'C', new ItemStack(ConfigItems.itemPrimalArrow,1,2), 'D', new ItemStack(ConfigItems.itemPrimalArrow,1,3), 'E', new ItemStack(ConfigItems.itemPrimalArrow,1,4), 'F', new ItemStack(ConfigItems.itemPrimalArrow,1,5));
		...
		for(int cm=0; cm<ItemCloak.subNames.length; cm++)
			registerArcaneRecipe("CLOAKKAMA", ("_" + cm), new ItemStack(WGContent.ItemKama, 1, cm), craftingAspects, "B", "C", 'B',  new ItemStack(ConfigItems.itemBaubleBlanks,1,2), 'C', new ItemStack(WGContent.ItemCloak, 1, cm));
		...
		registerInfusionRecipe("LABYRINTHSTRING","",new ItemStack(WGContent.ItemMaterial,1,11),2,infusionAspects,new ItemStack(ConfigBlocks.blockMagicalLog,1,0),new ItemStack[] {new ItemStack(Items.ender_pearl),new ItemStack(WGContent.ItemMaterial,1,0),new ItemStack(WGContent.ItemMaterial,1,1),new ItemStack(WGContent.ItemMaterial,1,0)});
		...
		registerInfusionRecipe("PRIMORDIALWEAPONRY","_CLAYMORE",new ItemStack(WGContent.ItemPrimordialSword),10,infusionAspects, OreDictionary.getOres("blockVoid").get(0),new ItemStack[] {new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemSwordVoid), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWandRod,1,0), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence),new ItemStack(ConfigItems.itemSwordVoid) });
		...
		registerInfusionRecipe("PRIMORDIALWEAPONRY","_HAMMER",new ItemStack(WGContent.ItemPrimordialHammer),10,infusionAspects, OreDictionary.getOres("blockVoid").get(0),new ItemStack[] {new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemPickVoid), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWandRod,1,0), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence),new ItemStack(ConfigItems.itemSwordVoid) });

		infusionAspects = new AspectList().add(Aspect.MAGIC,64).add(Aspect.METAL,128).add(Aspect.TOOL,32).add(Aspect.WEAPON,32).add(Aspect.AIR,32).add(Aspect.FIRE,32).add(Aspect.WATER,32).add(Aspect.EARTH,32).add(Aspect.ORDER,32).add(Aspect.ENTROPY,32);
		registerInfusionRecipe("PRIMORDIALWEAPONRY","_GREATAXE",new ItemStack(WGContent.ItemPrimordialAxe),10,infusionAspects, OreDictionary.getOres("blockVoid").get(0),new ItemStack[] {new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemAxeVoid), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWandRod,1,0), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence),new ItemStack(ConfigItems.itemAxeVoid) });
		...
		registerInfusionRecipe("PRIMORDIALARMOR","_HELMET",new ItemStack(WGContent.ItemPrimordialHelm),10,infusionAspects, OreDictionary.getOres("blockVoid").get(0),new ItemStack[] {new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemResource,1,16), new ItemStack(ConfigItems.itemHelmetFortress), new ItemStack(ConfigItems.itemResource,1,16), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWispEssence) });
		//ThaumcraftApi.addWarpToItem(new ItemStack(WGContent.ItemPrimordialAxe), 2);
		infusionAspects = new AspectList().add(Aspect.MAGIC,64).add(Aspect.METAL,128).add(Aspect.ARMOR,32).add(Aspect.AIR,32).add(Aspect.FIRE,32).add(Aspect.WATER,32).add(Aspect.EARTH,32).add(Aspect.ORDER,32).add(Aspect.ENTROPY,32);
		registerInfusionRecipe("PRIMORDIALARMOR","_CUIRASS",new ItemStack(WGContent.ItemPrimordialChest),10,infusionAspects, OreDictionary.getOres("blockVoid").get(0),new ItemStack[] {new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemResource,1,16), new ItemStack(ConfigItems.itemChestFortress), new ItemStack(ConfigItems.itemResource,1,16), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWispEssence) });
		//ThaumcraftApi.addWarpToItem(new ItemStack(WGContent.ItemPrimordialAxe), 2);
		infusionAspects = new AspectList().add(Aspect.MAGIC,64).add(Aspect.METAL,128).add(Aspect.ARMOR,32).add(Aspect.AIR,32).add(Aspect.FIRE,32).add(Aspect.WATER,32).add(Aspect.EARTH,32).add(Aspect.ORDER,32).add(Aspect.ENTROPY,32);
		registerInfusionRecipe("PRIMORDIALARMOR","_GREAVES",new ItemStack(WGContent.ItemPrimordialLegs),10,infusionAspects, OreDictionary.getOres("blockVoid").get(0),new ItemStack[] {new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemResource,1,16), new ItemStack(ConfigItems.itemLegsFortress), new ItemStack(ConfigItems.itemResource,1,16), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWispEssence) });
		//ThaumcraftApi.addWarpToItem(new ItemStack(WGContent.ItemPrimordialAxe), 2);
		infusionAspects = new AspectList().add(Aspect.MAGIC,64).add(Aspect.METAL,128).add(Aspect.ARMOR,32).add(Aspect.AIR,32).add(Aspect.FIRE,32).add(Aspect.WATER,32).add(Aspect.EARTH,32).add(Aspect.ORDER,32).add(Aspect.ENTROPY,32);
		registerInfusionRecipe("PRIMORDIALARMOR","_BOOTS",new ItemStack(WGContent.ItemPrimordialBoots),10,infusionAspects, OreDictionary.getOres("blockVoid").get(0),new ItemStack[] {new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemResource,1,16), new ItemStack(ConfigItems.itemBootsTraveller), new ItemStack(ConfigItems.itemResource,1,16), new ItemStack(ConfigItems.itemEldritchObject,1,3), new ItemStack(ConfigItems.itemWispEssence), new ItemStack(ConfigItems.itemResource,1,15), new ItemStack(ConfigItems.itemWispEssence) });
		//ThaumcraftApi.addWarpToItem(new ItemStack(WGContent.ItemPrimordialAxe), 2);
	...
	public static void registerResearch()
	{
		...
		getResearchItem("WGPOTIONS", "WITCHGADG", researchAspects, 2, -5, 0, new ResourceLocation("witchinggadgets:textures/gui/research/icon_potioneffects.png")).setRound().setAutoUnlock().setPages(pages).registerResearchItem();

		//ORIGINAL ENCHFABRIC
		getFakeResearchItem("ENCHFABRIC", "ARTIFICE", 12,4, new ItemStack(ConfigItems.itemResource, 1, 7)).registerResearchItem();

		//SPINNINGWHEEL
		researchAspects = new AspectList().add(Aspect.CLOTH, 3).add(Aspect.MAGIC, 4);
		...
		getResearchItem("SPINNINGWHEEL", "WITCHGADG", researchAspects, 10, 3, 3, new ItemStack(WGContent.BlockWoodenDevice,1,0)).setRound().setParents("WGFAKEENCHFABRIC").setPages(pages).registerResearchItem();

		//BEWITCHED FLEECE
		researchAspects = new AspectList().add(Aspect.CLOTH, 3).add(Aspect.MAGIC, 4).add(Aspect.TAINT, 1);
		pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.ADVANCEDROBES_CLOTH.1"), new ResearchPage((ShapelessArcaneRecipe) recipeList.get("ADVANCEDROBES_CLOTH"))};
		getResearchItem("ADVANCEDROBES_CLOTH", "WITCHGADG", researchAspects, 10, 1, 1, new ItemStack(WGContent.ItemMaterial,1,5)).setParents(new String[] { "SPINNINGWHEEL" }).setPages(pages).setConcealed().setSecondary().registerResearchItem();
		//SPACIOUS FOLDS
		researchAspects = new AspectList().add(Aspect.CLOTH, 3).add(Aspect.VOID, 4).add(Aspect.HUNGER, 1);
		pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.BAGOFTRICKS_CLOTH.1"), new ResearchPage((ShapelessArcaneRecipe) recipeList.get("BAGOFTRICKS_CLOTH"))};
		getResearchItem("BAGOFTRICKS_CLOTH", "WITCHGADG", researchAspects, 8, 3, 1, new ItemStack(WGContent.ItemMaterial,1,3)).setParents(new String[] { "SPINNINGWHEEL" }).setPages(pages).setConcealed().setSecondary().registerResearchItem();

		//ADVANCED ROBES
		researchAspects = new AspectList().add(Aspect.CLOTH, 3).add(Aspect.MAGIC, 4).add(Aspect.TAINT, 1);
		pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.ADVANCEDROBES.1"), new ResearchPage((ShapedArcaneRecipe) recipeList.get("ADVANCEDROBES_CHEST")), new ResearchPage((ShapedArcaneRecipe) recipeList.get("ADVANCEDROBES_LEGS"))};
		getResearchItem("ADVANCEDROBES", "WITCHGADG", researchAspects, 8, 1, 3, new ItemStack(WGContent.ItemAdvancedRobeChest,1,5)).setParents(new String[] { "ADVANCEDROBES_CLOTH" }).setPages(pages).setConcealed().registerResearchItem();

		//BAGOFTRICKS
		researchAspects = new AspectList().add(Aspect.CLOTH, 2).add(Aspect.VOID, 2).add(Aspect.HUNGER, 2);
		pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.BAGOFTRICKS.1"), new ResearchPage((ShapedArcaneRecipe) recipeList.get("BAGOFTRICKS_BAG"))};
		getResearchItem("BAGOFTRICKS", "WITCHGADG", researchAspects, 5, 3, 1, new ItemStack(WGContent.ItemBag,1,0)).setParents(new String[] { "BAGOFTRICKS_CLOTH" }).setConcealed().setPages(pages).registerResearchItem();
		//HUNGERBAG
		...
		getResearchItem("HUNGERBAG", "WITCHGADG", researchAspects, 4, 1, 1, new ItemStack(WGContent.ItemBag,1,3)).setPages(pages).setParents(new String[] { "BAGOFTRICKS","HUNGRYCHEST" }).setConcealed().setSecondary().registerResearchItem();
		//ENDERBAG
		...
		getResearchItem("CLOAK", "WITCHGADG", researchAspects, 10, -2, 2, standardCloak).setParents("ADVANCEDROBES_CLOTH").setConcealed().setPages(pages).registerResearchItem();
		...
		getResearchItem("CLOAK_SPECTRAL", "WITCHGADG", researchAspects, 12, -1, 3, new ItemStack(WGContent.ItemCloak,1,1)).setParents("CLOAK").setParentsHidden("INFUSION").setPages(pages).setConcealed().setSecondary().registerResearchItem();
		...
		getResearchItem("CLOAK_WOLF", "WITCHGADG", researchAspects, 8, -1, 3, new ItemStack(WGContent.ItemCloak,1,2)).setParents("CLOAK" ).setPages(pages).setConcealed().setSecondary().registerResearchItem();
		...
		if(WGModCompat.tfRavensFeather!=null)
		{
			...
			getResearchItem("CLOAK_RAVEN", "WITCHGADG", researchAspects, 12, -3, 3, new ItemStack(WGContent.ItemCloak,1,3)).setParents("CLOAK" ).setPages(pages).setConcealed().setSecondary().registerResearchItem();
		}
		...
		getResearchItem("CLOAKKAMA", "WITCHGADG", researchAspects, 8, -3, 1, new ItemStack(WGContent.ItemKama,1,0)).setParents("CLOAK").setConcealed().setSecondary().setPages(pages).registerResearchItem();
		...
		getResearchItem("LABYRINTHSTRING", "WITCHGADG", researchAspects, 9, 5, 1, new ItemStack(WGContent.ItemMaterial,1,11)).setPages(pages).setParents("INFUSION", "SPINNINGWHEEL").registerResearchItem();
		...
		getResearchItem("STONEEXTRUDER", "WITCHGADG", researchAspects, -3, -8, 1, new ItemStack(WGContent.BlockWoodenDevice,1,2)).setParents("WGFAKEARCANESTONE","THAUMIUM").setPages(pages).registerResearchItem();
		//ICEEXTRUDER
		...
		getResearchItem("ICEEXTRUDER", "WITCHGADG", researchAspects, -3, -9, 1, new ItemStack(WGContent.BlockWoodenDevice,1,1)).setParents("STONEEXTRUDER").setPages(pages).setSecondary().registerResearchItem();
		//AGEINGSTONE
		...
		getResearchItem("LABELLIB", "WITCHGADG", researchAspects, 5, -1, 2, new ItemStack(WGContent.BlockWoodenDevice,1,5)).setParents("WGFAKEJARLABEL").setPages(pages).setSecondary().registerResearchItem();
		...
		{	
			...
			getFakeResearchItem("MIRRORESSENTIA", "ARTIFICE", 1,-9,  new ItemStack(ConfigBlocks.blockMirror,1,6)).registerResearchItem();
		...
		//SCARECROW
		researchAspects = new AspectList().add(Aspect.AIR,2).add(Aspect.EARTH, 1).add(Aspect.WATER, 1);
		pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.SCARECROW.1"), new ResearchPage((List) recipeList.get("SCARECROW"))};
		getResearchItem("SCARECROW", "WITCHGADG", researchAspects, 3, -5, 3, new ResourceLocation("witchinggadgets:textures/gui/research/icon_scarecrow.png")).addWarp(2).setPages(pages).registerResearchItem();
		//SCANCAMERA
		...
		pages = new ResearchPage[]{
				...
				new ResearchPage("witchinggadgets_research_page.WGBAUBLES.3"), new ResearchPage((ShapedArcaneRecipe) recipeList.get("WGBAUBLES_HASTEVAMBRACES")),
				new ResearchPage("witchinggadgets_research_page.WGBAUBLES.4"), new ResearchPage((ShapedArcaneRecipe) recipeList.get("WGBAUBLES_DOUBLEJUMPSHOULDERS")),
				new ResearchPage("witchinggadgets_research_page.WGBAUBLES.5"), new ResearchPage((ShapedArcaneRecipe) recipeList.get("WGBAUBLES_SNIPERRING")),
		...
		getResearchItem("WGBAUBLES", "WITCHGADG", researchAspects, 2, -6, 1, new ItemStack(WGContent.ItemMagicalBaubles,1,2)).setParents("THAUMIUM").setPages(pages).registerResearchItem();




		//ORIGINAL ALCHEMICALMANUFACTURE
		getFakeResearchItem("ALCHEMICALMANUFACTURE", "ALCHEMY", -5,-6, new ResourceLocation("thaumcraft", "textures/misc/r_alchman.png")).registerResearchItem();
		//ALCHEMICALTRANSFORM
		...
		getResearchItem("ALCHEMICALTRANSMOGRIFY", "WITCHGADG", researchAspects, -7, -5, 1, new ItemStack(Blocks.grass)).setSecondary().setParents(new String[] { "WGFAKEALCHEMICALMANUFACTURE" }).setConcealed().setPages(pages).registerResearchItem();
		//ROSEVINE
		...
		getResearchItem("ROSEVINE", "WITCHGADG", researchAspects, -7, -7, 1, new ItemStack(WGContent.BlockRoseVine)).setSecondary().setParents(new String[] { "WGFAKEALCHEMICALMANUFACTURE" }).setConcealed().setPages(pages).registerResearchItem();

		//ORIGINAL PUREIRON
		getFakeResearchItem("PUREIRON", "ALCHEMY", -5,-3, new ItemStack(ConfigItems.itemNugget, 1, 16)).registerResearchItem();
		//PURECINNABAR
		...
		getResearchItem("PURECINNABAR", "WITCHGADG", researchAspects, -7, -3, 1, new ItemStack(ConfigItems.itemNugget, 1, 21)).setConcealed().setSecondary().setParents(new String[] { "WGFAKEPUREIRON" }).setPages(pages).registerResearchItem();
		...
		{
			//ORIGINAL TRANSIRON
			getFakeResearchItem("TRANSIRON", "ALCHEMY", -3,-3, new ItemStack(ConfigItems.itemNugget, 1, 0)).registerResearchItem();
		...
		getFakeResearchItem("INFERNALFURNACE", "ARTIFICE", 4,-9, new ResourceLocation("thaumcraft", "textures/misc/r_infernalfurnace.png")).registerResearchItem();
		...
		//ORIGINAL CENTRIFUGE
		getFakeResearchItem("CENTRIFUGE", "ALCHEMY", 7,-5, new ItemStack(ConfigBlocks.blockTube, 1, 2)).registerResearchItem();
		//TERRAFORMER
		...
		getResearchItem("TERRAFORMER", "WITCHGADG", researchAspects, 8, -7, 2, new ItemStack(WGContent.BlockMetalDevice,1,1)).setPages(pages).setParents("WGFAKECENTRIFUGE").registerResearchItem();
		...
		getResearchItem("TERRAFORMFOCUS_COLDTAIGA", "WITCHGADG", researchAspects, 7, -9, 2, new ItemStack(WGContent.BlockMetalDevice,1,3)).setSecondary().setPages(pages).setParents("TERRAFORMER").registerResearchItem();
		...
		getResearchItem("TERRAFORMFOCUS_DESERT", "WITCHGADG", researchAspects, 6, -8, 2, new ItemStack(WGContent.BlockMetalDevice,1,4)).setSecondary().setPages(pages).setParents("TERRAFORMER").registerResearchItem();
		...
		getResearchItem("TERRAFORMFOCUS_JUNGLE", "WITCHGADG", researchAspects, 8, -9, 2, new ItemStack(WGContent.BlockMetalDevice,1,5)).setSecondary().setPages(pages).setParents("TERRAFORMER").registerResearchItem();
		...
		getResearchItem("TERRAFORMFOCUS_HELL", "WITCHGADG", researchAspects, 9, -9, 2, new ItemStack(WGContent.BlockMetalDevice,1,6)).addWarp(2).setSecondary().setPages(pages).setParents("TERRAFORMER").registerResearchItem();
		...
		getResearchItem("TERRAFORMFOCUS_MUSHROOM", "WITCHGADG", researchAspects, 10, -8, 2, new ItemStack(WGContent.BlockMetalDevice,1,9)).setSecondary().setPages(pages).setParents("TERRAFORMER").registerResearchItem();
		...
		getResearchItem("PRIMORDIALGLOVE", "WITCHGADG", researchAspects, 2, 0, 2, new ItemStack(WGContent.ItemPrimordialGlove)).setParents("VOIDMETAL","WGFAKEPRIMPEARL", "GEMCUTTING").setConcealed().setPages(pages).registerResearchItem();
		//PRIMORDIALWEAPONRY
		...
		getResearchItem("VOIDBAG", "WITCHGADG", researchAspects, 3, 3, 1, new ItemStack(WGContent.ItemBag,1,1)).setParents(new String[] { "BAGOFTRICKS","ELDRITCHMINOR" }).setConcealed().setSecondary().setPages(pages).registerResearchItem();
